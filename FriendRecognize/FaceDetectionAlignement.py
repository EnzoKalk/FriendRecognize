...
# Load face detector - SSD ResNet 10 
...
while True:
    ...
    for bbox in bboxes:
        ...
        notAlignedFace = cv2.resize(frameFace[bbox[1]:bbox[3],bbox[0]:bbox[2]], (224,224))
        cv2.imshow("Not aligned face", notAlignedFace)
        cv2.imshow("Aligned face", faceim)
